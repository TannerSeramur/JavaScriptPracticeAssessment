...
function removeItem(arr, removedString){
  for(var i = arr.length; i >=0; i-- ){
		if(arr[i] === removedString){
			arr.splice(i,1)
		}
...
var newMessage = prompt("Please enter your message.");
...
makeChatMessage(newMessage, author)
...
function holla(string){
	console.log(string)
	return string;

}
function callerBack(holla, back){
	// console.log(holla(back) + ' back')
